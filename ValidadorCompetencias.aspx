<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ValidadorCompetencias.aspx.vb" Inherits="DNC_2017.ValidadorCompetencias" %>
                                ...
                                <div id="divDatos" runat="server" class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="ddlColaborador">Nombre de Colaborador</label>
                                            <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="box box-danger">
                                            <div class="box-header with-border">
                                                <h3 class="box-title">Compentencia</h3>
