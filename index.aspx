<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="index.aspx.vb" Inherits="DNC_2017.index" EnableEventValidation="false" %>
            ...
            <div class="content-wrapper">
                ...
                <div class="container">
                    ...
                    <section class="content-header">
                        <h1>Sistema de Gestión Integral de Desarrollo Organizacional
                                        ...
                                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                                            ...
                                            <div class="carousel-inner">
                                                ...
                                                <div class="item active">
                                                    <img src="img/Carrusel/Imagen%201B%20Talento%20DINA%20-%20Desarrollo%20Organizacional.jpg" />
                                                ...
                                                <div class="item">
                                                    ...
                                                    <img src="img/Carrusel/bg-nosotros-01.jpg" />
                                                    <div class="carousel-caption">
                                                    </div>
                                                </div>
                                                <div class="item">
                                   
                                                    <img src="img/Carrusel/bg-nosotros-03.jpg" />
                                                    <div class="carousel-caption">
                                                    </div>
                                                </div>
                                                    <div class="item">
                                     <img src="img/Carrusel/bg-nosotros-04.jpg" />
                                                    <div class="carousel-caption">
                                                    </div>
                                                </div>
                                            </div>
