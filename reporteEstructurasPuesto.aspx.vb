...
Public Class reporteEstructurasPuesto
...
#Region "Reporte"
    ...
    Public Sub obtReporte(Optional ByVal strBuscar As String = "")
        ...
        Try
            ...
            odbComando.CommandText = "do_reporte_envio_descriptivo_puesto_sp"
...
#Region "Excel"
    Public Sub obtExportarExcel(dsDatos As DataSet)
        ...
        Try
            ...
            Dim filename As String = "rpt_Envio_" & CStr(Now.Year & Now.Month & Now.Day & Now.Hour & Now.Minute & Now.Millisecond) & ".xls"
            ...
            dgGrid.HeaderStyle.BackColor = Drawing.Color.FromName("#1F497D")
    ...
    Protected Sub lnkExcel_Click(sender As Object, e As EventArgs)
        Call exportExcel()
    End Sub
...
#End Region
    ...
    Protected Sub lnkReporte_Click(sender As Object, e As EventArgs)
        Call obtReporte()
    End Sub
#Region "Seguridad"
