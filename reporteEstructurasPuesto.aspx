<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="reporteEstructurasPuesto.aspx.vb" Inherits="DNC_2017.reporteEstructurasPuesto" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <title>Reportes Estructura de Puestos | SIGIDO</title>
            ...
            <div class="content-wrapper">
                ...
                <div class="container">
                    ...
                    <section class="content-header">
                        <h1>Reportes de Estructura de Puestos      
                            <small>SIGIDO</small>
                        </h1>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="box box-danger">
                                            <div class="box-header with-border">
                                                <h3 class="box-title">Reporte de Envío / Notificación por Correo Electrónico de Descriptivos de Puestos </h3>

                                                <div class="box-tools pull-right">

                                                    <asp:LinkButton ID="lnkReporte" runat="server" class="btn btn-danger btn-flat btn-sm" data-toggle="tooltip" data-placement="left" title="Buscar Información" OnClientClick="return cargarBuscar();" OnClick="lnkReporte_Click"><i class="fa fa-search"></i></asp:LinkButton>

                                                    <asp:LinkButton ID="lnkExcel" runat="server" class="btn btn-danger btn-flat btn-sm" data-toggle="tooltip" data-placement="rigth" title="Exportar Excel" OnClientClick="return cargarBuscar();" OnClick="lnkExcel_Click"><i class="fa fa-file-excel-o"></i></asp:LinkButton>
                                                </div>
                                            </div>
                                            <!-- /.box-header -->
                                            <div class="box-body">
                                                <div class="row">
                                                    <div class="col-md-2">
                                                        <label for="txtFechaEmision" title="Fecha Emisión Desde">Fecha Envió Desde</label>
                                                    ...
                                                    <div class="col-md-2">
                                                        <label for="txtFechaEmisionHasta" title="Fecha Emisión Hasta">Fecha Envió Hasta</label>
    ...
    <script>
        ...
        function cargarBuscar() {
            ...
            if (document.getElementById("txtFechaEmision").value == '') {
                alert("Debe capturar la fecha de emisión.");
                document.getElementById("txtFechaEmision").focus();
                return false;
            }
