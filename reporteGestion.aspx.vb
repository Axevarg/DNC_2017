...
#Region "Reporte"
    ...
    Public Sub obtReporte(Optional ByVal strBuscar As String = "")
        ...
        Try
            ...
            odbComando.CommandText = "SELECT * FROM GC_CURSOS_VT"
...
#Region "Excel"
    Public Sub obtExportarExcel(dsDatos As DataSet)
        ...
        Try
            ...
            Dim filename As String = "rpt_Dnc_" & CStr(Now.Year & Now.Month & Now.Day & Now.Hour & Now.Minute & Now.Millisecond) & ".xls"
