...
#Region "Reporte"
    ...
    Public Sub generaCol(ByVal ds As DataSet)
        ...
        Dim iCol As Integer = grdReporte.Columns.Count
        ...
        If ds.Tables(0).Rows.Count > 0 Then
            ...
            If iCol > 1 Then
                For inContador = 0 To iCol - 1
                    ...
                    If grdReporte.Columns(iItem).HeaderText <> "ID" Then
                        grdReporte.Columns.RemoveAt(iItem)
                    End If
...
#Region "Excel"
    Public Sub obtExportarExcel(dsDatos As DataSet)
        ...
        Try
            ...
            Dim filename As String = "rpt_becas_" & CStr(Now.Year & Now.Month & Now.Day & Now.Hour & Now.Minute & Now.Millisecond) & ".xls"
