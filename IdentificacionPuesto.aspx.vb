        ...
        Try
            ...
            If rdTextoColaborador.Checked Then
                strEncabezadoCuerpo = "Estimado Colaborador (a).<br /><br />" &
                                        ...
                                        "<strong style=""color:#CC5200;"">Es importante que por este mismo medio nos notifiques de recibido y enterado de la información enviada, teniendo como máximo 3 días de tolerancia a partir del envío del presente correo; " &
